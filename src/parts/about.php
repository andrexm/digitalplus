<div class="px py2 grid md:grid-cols-2 items-center gap-4 lg:gap-8">
    <div>
        <img src="assets/img/about.png" class="mx-auto max-w-96">
    </div>
    ...
    <div>
        ...
        <div class="text-justify md:text-left text-neutral-700 lg:text-lg">
            ...
            <br><br>
            Integer auctor dictum nisi, sed faucibus erat ultrices nec. Maecenas vitae diam augue. Sed gravida velit vel nulla fermentum, sit amet rutrum massa placerat. Nulla eu fermentum ligula. Quisque cursus neque magna, at euismod lacus suscipit quis. Suspendisse sit amet iaculis odio.
        </div>
    </div>
</div>
